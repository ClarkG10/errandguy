    ...
    public function getTabs(): array
    {
        ...
        return [
            ...
            'active' => Tab::make('Active')->icon('heroicon-m-bolt')->badgeColor('info')
                ...
                ->modifyQueryUsing(fn (Builder $q): Builder => $q->whereNotIn('status', ['completed', 'cancelled', 'no_runner'])),
            ...
            'cancelled' => Tab::make('Cancelled')->icon('heroicon-m-x-circle')->badgeColor('danger')
                ...
                ->modifyQueryUsing(fn (Builder $q): Builder => $q->whereIn('status', ['cancelled', 'no_runner'])),
        ];
    }
}
