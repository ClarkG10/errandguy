...
| # | Gap | Fix |
|---|---|---|
| H1 | Chat/booking/receipt photos on public disk, unauthenticated | **[FIXED]** private `media` disk + participant-gated route + legacy-migration command |
